...
class CollectionTest extends TestCase
{
    ...
    public function testPush()
    {
        ...
        $this->assertSame(['http://www.github.com' => 10], $this->collection->toArray(), 'Pushed element is not present in returned array');
        $this->assertSame(1, $this->collection->count(), 'Count is invalid after pushing 1 element');
        $this->assertSame(['http://www.github.com'], $this->collection->all());
    }

    public function testPushDefaultDepth()
    {
        $this->collection->push('http://www.github.com');
        $this->assertSame(['http://www.github.com' => 0], $this->collection->toArray(), 'Pushed element is not present in returned array');
        $this->assertSame(1, $this->collection->count(), 'Count is invalid after pushing 1 element');
        $this->assertSame(['http://www.github.com'], $this->collection->all());
    }
    ...
    public function testAllFromDepth()
    {
        ...
        $this->assertSame(['http://www.github.com'], $this->collection->all(10));
        $this->assertSame(['http://www.bitbucket.org'], $this->collection->all(12));
    }
    ...
    public function testFromAndToAssoc()
    {
        ...
        $this->assertSame($assoc, $this->collection->toAssoc());
    }
    ...
    public function testCollectionIsEmptiedOnFromArrayOrAssoc()
    {
        ...
        $this->assertSame(0, $this->collection->count(), 'fromAssoc should empty the collection first');

        $this->collection->push('http://www.github.com');
        $this->assertSame(1, $this->collection->count());
        $this->collection->fromArray([]);
        $this->assertSame(0, $this->collection->count(), 'fromArray should empty the collection first');
    }
